 ...
 * Bagian: Mobile Menu, Animasi Scroll, Fungsionalitas Form Kontak, Inisialisasi Slider, dll.
 */
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        // Mengambil semua kontainer dropdown
    ...
    /* =================================================================
       5. Inisialisasi Slider 3D (SwiperJS)
       ================================================================= */
    ...
    if (typeof Swiper !== 'undefined') {
        ...
        console.error("SwiperJS library not found. Please make sure it is included in your HTML.");
    }
});
